...
# distance euclidienne (remplacée par la distance orthodromique)
...
if len(sys.argv) > 2 :
    print(parcours(sys.argv[1], sys.argv[2], [sys.argv[1]]))
else :
    print("python3 GPS_avec_AStar.py <ville de départ> <ville d'arrivée>")